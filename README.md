...
To support frame capture, recommendations, cleanup, saving, sorting, display features, and other on-device App functionality, the App may read necessary media metadata on device, such as:

* capture date and time;
* location information stored in media metadata;
* file type;
...
* orientation;
* other technical EXIF, HEIF, video, or media metadata available through iOS.
